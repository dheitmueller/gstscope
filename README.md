...
- Ten GPL-compatible, attributed sample pipelines, including RTP, compositor,
  tee, application-source, playback, and stress-test topologies.
...
The sample menu contains nine compact DOT fixtures generated by this project from
